...
export const B_FILE_MASK: bigint = 0x0202020202020202n;
export const NOT_B_FILE_MASK: bigint = FULL_BOARD_MASK ^ B_FILE_MASK;

export const NOT_A_B_FILE_MASK: bigint = NOT_A_FILE_MASK & NOT_B_FILE_MASK;

export const H_FILE_MASK: bigint = 0x8080808080808080n;
export const NOT_H_FILE_MASK: bigint = FULL_BOARD_MASK ^ H_FILE_MASK;

export const G_FILE_MASK: bigint = 0x4040404040404040n;
export const NOT_G_FILE_MASK: bigint = FULL_BOARD_MASK ^ G_FILE_MASK;

export const NOT_H_G_FILE_MASK: bigint = NOT_H_FILE_MASK & NOT_G_FILE_MASK;
...
export const NOT_RANK_7_8_MASK: bigint = NOT_RANK_7_MASK & NOT_RANK_8_MASK;
...
export const NOT_RANK_1_2_MASK: bigint = NOT_RANK_1_MASK & NOT_RANK_2_MASK;