import { BLACK_QUEENSIDE_ROOK_ORIGIN_SQUARE, BLACK_ROOK_QUEENSIDE_CASTLE_DESTINATION_SQUARE, WHITE_QUEENSIDE_ROOK_ORIGIN_SQUARE, WHITE_ROOK_QUEENSIDE_CASTLE_DESTINATION_SQUARE } from "../../../../constants/castling";
...
const queensideCastleMoveHandler = (position: Position, moveFrom: number, moveTo: number, moveColor: ColorType) => {
  ...
  if (moveColor === COLOR.WHITE) {
    ...
    rookFrom = BLACK_QUEENSIDE_ROOK_ORIGIN_SQUARE;
    rookTo = BLACK_ROOK_QUEENSIDE_CASTLE_DESTINATION_SQUARE;
  }
...
export default queensideCastleMoveHandler;
