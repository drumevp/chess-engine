...
const blackQueenCastling = (ctx: MoveGenerationContext, attackInfo: AttackInfo): void => {
  ...
  ctx.moves.push(encodeMove(ctx.ownKingSquare, BLACK_KING_QUEENSIDE_CASTLE_DESTINATION_SQUARE, ctx.color, KING_INDEX, MOVE_FLAG.QUEEN_CASTLE));
}
