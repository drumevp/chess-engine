...
import { betweenSquares, squareBitboards, squareIndexByBitboard } from "../../lookupTables/importedPrecalculatedData";
import { BISHOP_INDEX, calculatePieceIndex, QUEEN_INDEX, ROOK_INDEX } from "../../state/initialState";
import type { MoveGenerationContext } from "../types";

const getPins = (ctx: MoveGenerationContext): {pinnedPieces: bigint, pinRaysBySquare: bigint[]}  => {
  let pinnedPieces: bigint = 0n;
  const pinRaysBySquare: bigint[] = new Array(64).fill(0n);
