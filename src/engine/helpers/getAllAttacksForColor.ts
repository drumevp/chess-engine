...
import { BISHOP_INDEX, calculatePieceIndex, KING_INDEX, KNIGHT_INDEX, PAWN_INDEX, QUEEN_INDEX, ROOK_INDEX } from "../state/initialState";
...
const getAllAttacksForColor = (color: ColorType, state: bigint[], allOccupancy: bigint):bigint => {
